...
<style>
  ...
  .cluster-box {{ background: #f8f9fb; border: 1px solid #e0e3ea; border-radius: 6px; padding: 1rem; margin: 1rem 0; overflow-x: auto; }}
  .cluster-box table {{ table-layout: fixed; }}
  .cluster-box td, .cluster-box th {{ word-wrap: break-word; overflow-wrap: break-word; }}
